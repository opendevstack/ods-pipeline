...
test-tasks: ## Run testsuite of Tekton tasks.
	go test -parallel -json -v -count=1 -timeout $${ODS_TESTTIMEOUT:-30m} ./test/tasks/... | go run cmd/disentangle-output/main.go -test-result-dir=./test/testdata/test-results
.PHONY: test-tasks
