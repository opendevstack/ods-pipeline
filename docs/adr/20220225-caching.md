...
3. For repos with multiple build tasks one frequently could skip builds if nothing has changed. This can be enabled by storing a build tasks output in the cache.
