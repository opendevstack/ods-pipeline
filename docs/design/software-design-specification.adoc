...
| Container image to build Python applications. Based on `ubi8/python-39` (SDS-EXT-28), includes SDS-EXT-14, SDS-EXT-15, SDS-SHARED-3, SDS-TASK-15 and SDS-TASK-27.
