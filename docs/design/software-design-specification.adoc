...
Generates the SBOM report of the image using SDS-EXT-31. The resulting report is placed in `.ods/artifacts/sboms/sbom.spdx` in link:https://spdx.dev/[SPDX] format.
