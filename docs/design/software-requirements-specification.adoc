...
a| The task shall build a container image unless the image tag already exists.
...
| 2021-11-24
| Michael Sauter
| Detailed requirement SRS-TASK-SHARED-1, specifying default SQ properties.

| 0.2
| 2021-11-23
| Michael Sauter
| Detailed requirement SRS-TASK-SHARED-1, specifying an optional SonarQube guality gate check.
