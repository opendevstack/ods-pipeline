...
[source]
----
pipelineGitRef=v0.10.1 # Pick the version you want to install
...
[source]
----
pipelineGitRef=v0.10.1 # Pick the version you want to update to
